 ...
 */
class ListenPhoneDetector : Detector(), ClassScanner {
    ...
    companion object {
        val ISSUE = Issue.create(
            ...
            Implementation(
                ListenPhoneDetector::class.java,
    ...
    override fun checkInstruction(context: ClassContext, classNode: ClassNode, method: MethodNode, instruction: AbstractInsnNode) {
        ...
        if (methodInsn.name == "listen"&&methodInsn.owner=="android/telephony/TelephonyManager") {
