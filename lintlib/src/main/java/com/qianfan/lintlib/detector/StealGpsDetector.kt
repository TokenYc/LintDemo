 ...
 */
class StealGpsDetector : Detector(), ClassScanner {
    ...
    override fun checkInstruction(context: ClassContext, classNode: ClassNode, method: MethodNode, instruction: AbstractInsnNode) {
        ...
        if (methodInsn.name == "getLastKnownLocation"&&methodInsn.owner=="android/location/LocationManager") {
