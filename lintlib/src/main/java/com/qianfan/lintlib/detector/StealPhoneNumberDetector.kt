 ...
 */
class StealPhoneNumberDetector : Detector(), ClassScanner {

    companion object {
        val ISSUE = Issue.create(
            "StealPhoneNumber",//问题 Id
            ...
            Implementation(
                StealPhoneNumberDetector::class.java,
    ...
    override fun checkInstruction(context: ClassContext, classNode: ClassNode, method: MethodNode, instruction: AbstractInsnNode) {
        ...
        if (methodInsn.name == "getLine1Number"&&methodInsn.owner=="android/telephony/TelephonyManager") {
